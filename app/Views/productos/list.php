                                ...
                                <?php if(!empty($producto)):?>
                                    <?php foreach($producto as $producto):?>
                                        <tr>
                                            ...
                                            <?php $dataproducto = $producto->Nombre."*".$producto->Cantidad."*";?>
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <a href="<?php echo base_url()?>/productos/edit/<?php echo $producto->idProductos ;?>" class="btn btn-warning"><span class="fa fa-pencil"></span></a>
